            ...
            <div class="sidebar col-xl-2 py-3 px-1 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <div class="link-section mb-1 mt-3 border border-white rounded-2">
                        <div class="head row justify-content-between cursor-pointer {{ Request::routeIs('student.about') ? 'active' : '' }}">
                            <a href="{{ route('student.about') }}" class="col row ps-3 pe-2 py-2 bg-transparent text-decoration-none">
                                <div class="left col-auto px-0">
